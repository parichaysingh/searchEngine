...
public class EditDistance {
    ...
    final static String filePath = "F:/Windsor Sem-1/Advance Computing Concepts/Assignments-workspace/searchengine/src/dao/Words.txt";
    ...
    private ArrayList<String> makeSuggestions(String input) {
    	System.out.println("makesuggestions");
